-- Original script is made by casanova
-- kodumun otistiği burdan skidlemişsin orospu evladi seni
-- init
...
local PlayerRoot = FindFirstChild(LocalPlayer.Character, SilentAimSettings.TargetPart) or FindFirstChild(LocalPlayer.Character, "HumanoidRootPart")
if not PlayerRoot then
    return
end

local CastPoints, IgnoreList = {PlayerRoot.Position, LocalPlayer.Character, LocalPlayer}, {LocalPlayer.Character, LocalPlayer}
...
do
    ...
    Main:AddToggle("MousePosition", {Text = "Show Silent Aim Target"}):AddColorPicker("MouseVisualizeColor", {
        Default = Color3.fromRGB(54, 57, 241)
    }):OnChanged(function()
...
do
    ...
    Main:AddInput("CreateConfigTextBox", {
        Default = "",
        Numeric = false,
        Finished = false,
...
do
    ...
    Main:AddDropdown("SaveConfigurationDropdown", {
        Values = GetFiles(),
...
do
    ...
    Main:AddDropdown("LoadConfigurationDropdown", {
        Values = GetFiles(),
